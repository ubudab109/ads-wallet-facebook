...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Detail Ticket User</h2>
    </div>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="intro-y col-span-12 lg:col-span-8">
                          <div class="mt-5 mb-5">
                            ...
                            <input type="text" name="email" value="{{$ticket->user->email}}" class="intro-y form-control py-3 px-4 box pr-10 placeholder-theme-13" placeholder="Title" readonly disabled>
                            <a href="{{route('chat.index')}}?useremail={{$ticket->user->email}}">Klik Disini Untuk Chat Dengan User</a>
                          </div>
