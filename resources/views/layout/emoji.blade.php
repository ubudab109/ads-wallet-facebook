<div class="dropdown mr-3 sm:mr-5" style="position: relative;">
  <a href="javascript:;" class="dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block text-gray-600" aria-expanded="false"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-smile w-full h-full"><circle cx="12" cy="12" r="10"></circle><path d="M8 14s1.5 2 4 2 4-2 4-2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg> </a>
  <div class="chat-dropdown dropdown-menu" id="_7thx8no93" data-popper-placement="top-end" style="position: absolute; inset: auto auto 0px 0px; transform: translate(-300px, -20px);">
                  ...
                  <div id="history" class="h-full tab-pane" role="tabpanel" aria-labelledby="history-tab">
                      ...
                      <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                          <div class="grid grid-cols-8 text-2xl">
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">😀</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">😁</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">😂</button>
                          </div>
                      </div>
                  ...
                  <div id="smile" class="h-full tab-pane active" role="tabpanel" aria-labelledby="smile-tab">
                      ...
                      <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                          <div class="grid grid-cols-8 text-2xl">
                              ...
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">😙</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">😚</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">☺️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🙂</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🤗</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🤩</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🤔</button>
                              ...
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">👮‍♀️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🕵️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🕵️‍♂️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🕵️‍♀️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">💂</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">💂‍♂️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">💂‍♀️</button>
                  ...
                  <div id="music" class="h-full tab-pane" role="tabpanel" aria-labelledby="music-tab">
                      ...
                      <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                          <div class="grid grid-cols-8 text-2xl">
                              ...
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">®️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">™️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">#️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">*️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">0️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">1️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">2️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">3️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">4️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">5️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">6️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">7️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">8️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">9️⃣</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🔟</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">💯</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🔠</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🔡</button>
                              ...
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🆒</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🆓</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">ℹ️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🆔</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">Ⓜ️</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🆕</button>
                              <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2 emoji" type="button" onclick="emoji(this)">🆖</button>
