...
@section('subcontent')
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="form-reject" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    {{-- DETAIL MODAL --}}
...
@section('script')
    <script>
      ...
      var table = new Tabulator("#form-reject", {
        ajaxURL:"{{route('form-reject.index')}}", //set url for ajax request
        ajaxFiltering: true,
        ajaxSorting: true,
        printAsHtml: true,
        printStyled: true,
        ...
        columns: [
                ...
                },
                {
                    ...
                    download: false,
                    formatter(cell, formatterParams) {
                        var a = cash(`<div id="icon-dropdown" class="p-5">
                                        <div class="preview">
                                                    ...
                                                    <div class="dropdown-menu w-48">
                                                        <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                                            <a href="javascript:;" data-toggle="modal" data-target="#large-modal-size-preview" onclick="detail('${cell.getData().id}')" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">
                                                                <i data-feather="edit-2" class="w-4 h-4 mr-2"></i> Detail
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
