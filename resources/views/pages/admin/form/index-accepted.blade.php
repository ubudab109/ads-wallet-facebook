...
@section('subcontent')
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="form-accept" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    {{-- DETAIL MODAL --}}
...
@section('script')
    <script>
      ...
      var table = new Tabulator("#form-accept", {
        ajaxURL:"{{route('form-accept.index')}}", //set url for ajax request
        ajaxFiltering: true,
        ajaxSorting: true,
        printAsHtml: true,
        printStyled: true,
